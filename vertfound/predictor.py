...
class VertFound_Predictor:
    def __init__(
        ...
        super().__init__()
        self.vertfound = vertfound
        self.model = self.vertfound.sam
    ...
    def set_torch_image(
        ...
        self.clip_features = self.vertfound.clip_model.encode_image_featuremap(self.resized_image.cuda()).detach()
    ...
    def predict_torch(
        ...
        with amp.autocast(enabled=True):
            with torch.no_grad():
                logits_per_image = self.vertfound.forward_inference(self.clip_features, mask_token.cuda(), self.resized_image.cuda())
        #get class and score
