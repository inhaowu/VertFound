...
COCO_INSTANCE_CLASSES = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 
...
VERT_CLASSES_1 = ['Vertebrae_S', 'Vertebrae_L5','Vertebrae_L4','Vertebrae_L3','Vertebrae_L2','Vertebrae_L1',
...
from vertfound.data.v3det_categories import categories
