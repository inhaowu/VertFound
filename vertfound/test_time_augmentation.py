...
class VertFoundWithTTA(GeneralizedRCNNWithTTA):

    def __init__(self, cfg, model, tta_mapper=None, batch_size=3):
        """
            Args:
                cfg (CfgNode):
                model ( VertFound): a  VertFound to apply TTA on.
        ...
        self.max_detection = cfg.MODEL.VertFound.NUM_PROPOSALS
    ...
    def _merge_detections(self, all_boxes, all_scores, all_classes, shape_hw):
        ...
        num_classes = self.cfg.MODEL. VertFound.NUM_CLASSES
